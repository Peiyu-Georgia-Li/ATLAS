...
DIRECTORY <- "cat_winogrande_random_EAP/"
...
score_response <- function(model_name, item_id) {
  # Read the data once
  response_data <- read.csv("../select_model/gaussian_sampled_winogrande_response_matrix_train.csv", stringsAsFactors = FALSE, check.names = FALSE) #⚠️
...
data <- read.csv("../select_model/gaussian_sampled_winogrande_response_matrix_train.csv")##⚠️
