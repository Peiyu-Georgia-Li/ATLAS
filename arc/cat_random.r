...
score_response <- function(model_name, item_id) {
  # Read the data once
  response_data <- read.csv("../select_model/gaussian_sampled_arc_response_matrix.csv", stringsAsFactors = FALSE, check.names = FALSE) #⚠️
...
data <- read.csv("../select_model/gaussian_sampled_arc_response_matrix.csv")##⚠️
