...
selected_items_df <- read.csv(paste0("/store01/nchawla/pli9/llmbenchmark/baseline_compare/random_100_", DATASET_NAME, "_selected_items.csv"), stringsAsFactors = FALSE)
